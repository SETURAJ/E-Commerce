<%@ Page Title="" Language="C#" MasterPageFile="~/SRC/user.Master" AutoEventWireup="true" CodeBehind="payment.aspx.cs" Inherits="E_Commerce.SRC.payment" %>
        ...
        <div class="col-md-3" runat="server" id="divPriceDetails">
             <div style="border-bottom: 1px solid #eaeaec;">
                ...
                <div>
                    ...
                    <span class="float-right priceGray" id="spanCartTotal" runat="server">&nbsp &nbsp &nbsp &nbsp 202000</span>
                </div>
                <div>
                    <label>Cart Discount</label>
                    <span class="float-right priceGreen" id="spanDiscount" runat="server">-15000</span>
                </div>
            </div>
            </div>
            ...
            <div>
                <div class="proPriceView">
                    <label>&nbsp &nbsp Total</label>
                    <span class="float-right" id="spanTotal" runat="server">  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 187000</span>
                </div>
            </div>
        </div>
